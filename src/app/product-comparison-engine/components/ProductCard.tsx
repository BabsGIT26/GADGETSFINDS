  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        />
        {product.isNew && (
          <div className="absolute top-3 left-3 px-2 py-1 bg-brand-primary text-brand-dark text-xs font-bold rounded">
            NEW
          </div>
        )}
        {discount > 0 && (
          <div className="absolute top-3 right-3 px-2 py-1 bg-destructive text-destructive-foreground text-xs font-bold rounded">
            -{discount}%
          </div>
        )}
        <button
        ...
        >
          <Icon
            name={isComparing ? 'CheckIcon' : 'PlusIcon'}
            size={20}
            variant="outline"
          />
        </button>
      ...
      <div className="p-4 space-y-3">
        <div>
          ...
          <h3 className="font-display font-semibold text-base text-foreground mt-1 line-clamp-2">
            {product.name}
          </h3>
        </div>
              ...
              <Icon
                ...
                className={
                  index < Math.floor(product.rating)
                    ? 'text-brand-cta' :'text-muted-foreground'
                }
              />
            ))}
          </div>
